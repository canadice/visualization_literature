...
### Andra diagram för beskrivande statistik
...
kable(iris_agg, format = "html", caption = "Aggregerad datamaterial för iris") %>%
  kable_styling(position = "center", full_width = FALSE)
